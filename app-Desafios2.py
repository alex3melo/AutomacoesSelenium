...
campo_nome.send_keys('Alex Martins')
sleep(1)

botao_cl = driver.find_element(By.XPATH, '//section//button[@id="desafio2"]')
sleep(1)
...
campo_escondido.send_keys('Alex Martins')
sleep(1)

botao_validar = driver.find_element(By.XPATH, '//button[@id="validarDesafio2"]')
sleep(1)
